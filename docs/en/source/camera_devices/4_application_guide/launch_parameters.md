...
*   **`accel_rate`** / **`gyro_rate`**
    *   The frequency of the accelerometer/gyroscope. Values range from `1.5625hz` to `32khz`. High-rate values can be written as `1000hz`, `2000hz`, `4000hz`, `8000hz`, `16000hz`, or `32000hz`; the equivalent `1khz`–`32khz` forms remain supported.
